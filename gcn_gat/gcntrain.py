...
def train(args, model, train_loader,A):
...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        probs, labels_all, prices_all = test(model, test_loader,A)
